    ...
    internal class VolumeControlHelper
    {
        ...
        public struct MIXERCONTROL
        {
            ...
            [MarshalAs(UnmanagedType.ByValTStr,
                SizeConst = MIXER_SHORT_NAME_CHARS)] public string szShortName;
                                             ...
                                             int ctrlType, out MIXERCONTROL mxc, out int vCurrentVol)
        {
            ...
            var mxlc = new MIXERLINECONTROLS();

            var mxl = new MIXERLINE();

            var pmxcd = new MIXERCONTROLDETAILS();
                                             ...
                                             int volume)
        {
            ...
            var mxcd = new MIXERCONTROLDETAILS();
